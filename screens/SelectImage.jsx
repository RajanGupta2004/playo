import { View, Text, Image, Pressable, TextInput, KeyboardAvoidingView, ScrollView, Platform, TouchableWithoutFeedback, Keyboard } from 'react-native';
...
const SelectImage = () => {
    ...
    const images = [
        { id: '1', image: 'https://cdn-icons-png.flaticon.com/128/16683/16683469.png' },
        { id: '2', image: 'https://cdn-icons-png.flaticon.com/128/16683/16683439.png' },
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    ...
                    >
                        ...
                        <View style={{ justifyContent: "center", alignItems: "center", padding: 3 }}>
                            <Image 
                                style={{ width: 100, height: 100, borderRadius: 100, borderColor: "green", borderWidth: 2 }} 
                        ...
                        <Text style={{ textAlign: "center", fontSize: 18, marginVertical: 10, color: "gray" }}>OR</Text>

                        <View style={{ marginHorizontal: 10 }}>
                            <Text style={{ fontSize: 18, color: "gray" }}>Enter image link...</Text>
                            <TextInput 
                ...
                <Pressable 
                    ...
                    style={{ backgroundColor: "green", marginVertical: 10, padding: 10, marginHorizontal: 7, alignItems: "center" }}
                >
